...
"""Coldfront allocation_openldap plugin signals.py"""
...
def send_project_new_signal(sender, **kwargs):
    ...
    async_task("coldfront.plugins.allocation_openldap.tasks.add_project", project_obj)
...
def send_project_archive_signal(sender, **kwargs):
    project_obj = kwargs.get("project_obj")
    async_task("coldfront.plugins.allocation_openldap.tasks.remove_project", project_obj)
...
def send_project_update_signal(sender, **kwargs):
    project_obj = kwargs.get("project_obj")
    async_task("coldfront.plugins.allocation_openldap.tasks.update_project", project_obj)
...
def send_project_activate_user_signal(sender, **kwargs):
    ...
    async_task("coldfront.plugins.allocation_openldap.tasks.add_user_project", project_user_pk)
...
def send_project_remove_user_signal(sender, **kwargs):
    project_user_pk = kwargs.get("project_user_pk")
    async_task("coldfront.plugins.allocation_openldap.tasks.remove_user_project", project_user_pk)
